const userActionTypes = {
    ...
    SEARCH_USERS_BY_EMAIL_REQUESTED: "SEARCH_USERS_BY_EMAIL_REQUESTED",
    SEARCH_USERS_BY_EMAIL_SUCCEEDED: "SEARCH_USERS_BY_EMAIL_SUCCEEDED",
    SEARCH_USERS_BY_EMAIL_FAILED: "SEARCH_USERS_BY_EMAIL_FAILED",
