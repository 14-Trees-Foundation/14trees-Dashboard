...
const onsiteStaffActionTypes = {
    GET_ONSITE_STAFF_REQUESTED: "GET_ONSITE_STAFF_REQUESTED",
    GET_ONSITE_STAFF_SUCCEEDED: "GET_ONSITE_STAFF_SUCCEEDED",
    GET_ONSITE_STAFF_FAILED: "GET_ONSITE_STAFF_FAILED",
