const organizationActionTypes = {
    ...
    SEARCH_ORGANIZATIONS_REQUESTED: "SEARCH_ORGANIZATIONS_REQUESTED",
    SEARCH_ORGANIZATIONS_SUCCEEDED: "SEARCH_ORGANIZATIONS_SUCCEEDED",
    SEARCH_ORGANIZATIONS_FAILED: "SEARCH_ORGANIZATIONS_FAILED",
