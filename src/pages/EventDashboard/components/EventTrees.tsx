import { Box, Button, FormControl, FormControlLabel, FormGroup, Radio } from "@mui/material"
...
const EventTrees: React.FC<EventTreesProps> = ({ eventId }) => {
    ...
    const getTrees = async (eventId: number, offset: number, limit: number) => {
        ...
        try {
            ...
            const treesResp = await apiClient.getTrees(offset, limit, [{
