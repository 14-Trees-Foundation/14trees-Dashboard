...
import AddUser from './AddTreeType';
...
export const TreeType = () => {
	...
	const treeTypesMap = useAppSelector((state: RootState) => state.treeTypesData);
	if (treeTypesMap) {
    ...
    return (
        <>
            <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '20px' }}>
                <Button variant="contained" onClick={handleModalOpen}>Add Tree type</Button>
