...
const defaultMessages = {
    ...
    wedding: prefixMessage + 'We are delighted to share that a tree has been planted in your name to celebrate your special union at the 14 Trees Foundation, Pune. This tree will be nurtured in your honour, helping offset the harmful effects of climate change.' + "\n\n" + secondaryMessage,
    anniversary: prefixMessage + 'We are delighted to share that a tree has been planted in your name to celebrate your Wedding Anniversary at the 14 Trees Foundation, Pune. This tree will be nurtured in your honour, helping offset the harmful effects of climate change.' + "\n\n" + secondaryMessage,
    festival: prefixMessage + 'We are delighted to share that a tree has been planted in your name to celebrate this joyous occasion at the 14 Trees Foundation, Pune. This tree will be nurtured in your honour, helping offset the harmful effects of climate change.' + "\n\n" + secondaryMessage,
