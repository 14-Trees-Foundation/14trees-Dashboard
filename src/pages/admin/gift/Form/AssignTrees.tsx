import { TextField, Box, Button, Dialog, DialogActions, DialogContent, DialogTitle, Modal, ToggleButton, ToggleButtonGroup, Typography } from "@mui/material";
    ...
    const getGiftRequestUsers = async (giftRequestId: number) => {
        ...
        try {
            ...
            setUsers(usersResp.map(user => ({
                ...
                assignee_email: user.assignee_email ?? "N/A",
            })));
        } catch (error: any) {
            toast.error(error.message);
        }
    ...
    const columns: TableColumnsType<GiftCardUser> = [
        {
            ...
            align: "center",
            width: 120,
            ...getColumnSearchProps('sapling_id', filters, handleSetFilters) // Dynamic filter
        },
        {
            ...
            align: "center",
            width: 200,
            ...getColumnSearchProps('plant_type', filters, handleSetFilters) // Dynamic filter
        },
        {
            ...
            align: "center",
            width: 200,
            ...getColumnSearchProps('recipient_name', filters, handleSetFilters) // Dynamic filter
        },
        {
            ...
            align: "center",
            width: 200,
            ...getColumnSearchProps('assignee_name', filters, handleSetFilters) // Dynamic filter
        },
        {
            dataIndex: "action",
            key: "action",
    ...
    return (
        <Dialog open={open} fullWidth maxWidth="lg">
                ...
                <Box>
                    ...
                    <Box mt={2} display="flex" alignItems="center" justifyContent="space-between">
                        ...
                        <ToggleButtonGroup
                            ...
                            exclusive
                            onChange={(e, value) => setAutoAssign(value === "yes")}
                            aria-label="Platform"
                            size="small"
                        >
            ...
            <DialogActions>
                ...
                <Button onClick={handleAutoAssignTrees} color="success" variant="contained">Confirm</Button>
            </DialogActions>
        </Dialog>
    );
};
