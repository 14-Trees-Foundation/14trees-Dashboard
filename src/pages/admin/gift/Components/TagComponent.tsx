...
const TagComponent: React.FC<TagComponentProps> = ({
	...
	return (
		<Dialog open={open} fullWidth maxWidth="md">
			<DialogTitle>
				{getDialogTitleWithReqId('Tag request', requestId)}
			</DialogTitle>
			<DialogContent dividers>
				<Box mt={2}>
					<Typography mb={1}>
						You can tag the tree card request by selecting existing tags from
						the list below or adding new ones.
					</Typography>
					<TagSelector
						showLabels={false}
						...
						value={tagsList}
						handleChange={(tags: string[]) => setTagsList(tags)}
					/>
				</Box>
			</DialogContent>
			<DialogActions>
