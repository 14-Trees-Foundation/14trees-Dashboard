...
const GiftTrees: FC = () => {
    ...
    const handleSendEmails = async (testMails: string[], ccMails: string[], templateType: string, attachCard: boolean) => {
        ...
        const apiClient = new ApiClient();
        try {
            await apiClient.sendEmailToGiftRequestUsers(giftCardRequestId, templateType, attachCard, ccMails.length > 0 ? ccMails : undefined, testMails.length > 0 ? testMails : undefined);
