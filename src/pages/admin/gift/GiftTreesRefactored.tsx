...
const GiftTrees: React.FC = () => {
	...
	const actionHandlers = {
		...
		handleOpenPlotSelection: handlers.handleOpenPlotSelection,
	...
	return (
		<div>
			...
			{(auth.signedin || import.meta.env.VITE_BYPASS_AUTH === 'true') && (
				<Box
					id="tree-cards-table"
					sx={{ height: 840, width: '100%', scrollMarginTop: '20px' }}
				>
					<GeneralTable
			...
			<GiftCardModals
				...
				plotAutoBookRulesRef={state.plotAutoBookRulesRef}
				plotAutoBookValidationErrorRef={state.plotAutoBookValidationErrorRef}
			...
			<div
				id="tree-cards-sponsorship"
				style={{ marginTop: '20px', scrollMarginTop: '20px' }}
			>
			...
			<Divider sx={{ my: 4, backgroundColor: 'transparent' }} />
			<Box
				id="tree-cards-auto-processing"
				sx={{ minHeight: 540, scrollMarginTop: '20px' }}
			>
