...
export const CampaignsPage = () => {
	...
	const pageContainerStyle = {
		p: 2,
		background:
			'linear-gradient(135deg, rgba(155, 197, 61, 0.1) 0%, rgba(114, 143, 121, 0.2) 50%, rgba(63, 83, 68, 0.15) 100%)',
		minHeight: '100vh',
		position: 'relative',
		'&::before': {
			content: '""',
			...
			bottom: 0,
			background:
				'radial-gradient(circle at 20% 50%, rgba(155, 197, 61, 0.08) 0%, transparent 50%), radial-gradient(circle at 80% 80%, rgba(63, 83, 68, 0.06) 0%, transparent 50%)',
			pointerEvents: 'none',
		},
	};
	...
	if (error === '404') {
		return (
			<NotFound text="This campaign seems to have wandered off the trail!" />
		);
	}
	...
	return (
		<Box sx={{ ...pageContainerStyle, p: 0, m: 0 }}>
			<AppBar
				...
				sx={{
					background:
						'linear-gradient(135deg, #3F5344 0%, #2C3A2F 50%, #1A2319 100%)',
					...
					'&::before': {
						...
						bottom: 0,
						background:
							'radial-gradient(circle at 30% 50%, rgba(155, 197, 61, 0.15) 0%, transparent 60%), radial-gradient(circle at 70% 50%, rgba(155, 197, 61, 0.1) 0%, transparent 50%)',
						pointerEvents: 'none',
					},
					'&::after': {
						content: '""',
						...
						height: '3px',
						background:
							'linear-gradient(90deg, #9BC53D 0%, #7A9E2F 50%, #9BC53D 100%)',
			...
			>
				...
				>
					...
					{isMobile ? (
						...
						<Box
							sx={{ display: 'flex', gap: { sm: 1.5, md: 2.5 }, flexShrink: 0 }}
						>
							<Button
								variant="contained"
					...
					<Fade in timeout={1000}>
						<Card
							sx={{
								...
								'&:hover': {
									boxShadow: {
										xs: '0 12px 48px rgba(63, 83, 68, 0.2)',
										sm: '0 16px 56px rgba(63, 83, 68, 0.22)',
									},
