        ...
        <div>
            <Grid container>
                ...
                <Grid item xs={4} md={3} xl={2}>
                    <div className={classes.card}>
                        <Box sx={{ paddingTop: '10px' }}>
                            ...
                            <Typography variant="h3" color="#fff" sx={{ pt: 1, pb: 1 }}>{adminSummary.treeCount}</Typography>
                ...
                <Grid item xs={4} md={3} xl={2}>
                    <div className={classes.card}>
                        <Box sx={{ paddingTop: '10px' }}>
                            ...
                            <Typography variant="h3" color="#fff" sx={{ pt: 1, pb: 1 }}>{adminSummary.treeTypeCount}</Typography>
                ...
                <Grid item xs={4} md={3} xl={2}>
                    <div className={classes.card}>
                        <Box sx={{ paddingTop: '10px' }}>
                            <AssignmentIndTwoToneIcon fontSize='large' style={{color:'#6166B8'}}/>
                            <Typography variant="h3" color="#fff" sx={{ pt: 1, pb: 1 }}>{adminSummary.assignedTreeCount}</Typography>
                ...
                <Grid item xs={4} md={3} xl={2}>
                    <div className={classes.card}>
                        <Box sx={{ paddingTop: '10px' }}>
                            <PermIdentityTwoToneIcon fontSize='large' style={{color:'#C72542'}}/>
                            <Typography variant="h3" color="#fff" sx={{ pt: 1, pb: 1 }}>{adminSummary.userCount}</Typography>
                ...
                <Grid item xs={4} md={3} xl={2}>
                    <div className={classes.card}>
                        <Box sx={{ paddingTop: '10px' }}>
                            <TerrainTwoToneIcon fontSize='large' style={{color:'#573D1C'}}/>
                            <Typography variant="h3" color="#fff" sx={{ pt: 1, pb: 1 }}>{adminSummary.plotCount}</Typography>
                ...
                <Grid item xs={4} md={3} xl={2}>
                    <div className={classes.card}>
                        <Box sx={{ paddingTop: '10px' }}>
                            ...
                            <Typography variant="h3" color="#fff" sx={{ pt: 1, pb: 1 }}>{adminSummary.pondCount}</Typography>
