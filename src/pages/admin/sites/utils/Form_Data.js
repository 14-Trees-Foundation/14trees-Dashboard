export const ownerOptions = [
	{
		value: 'GramPanchayat (ग्राम पंचायत)',
		label: 'Gram Panchayat (ग्राम पंचायत)',
	},
...
export const LandTypeOptions = [
	...
	{ value: 'Gairan (गायरान)', label: 'Gairan (गायरान)' },
	{ value: 'School (शाळा)', label: 'School (शाळा)' },
	{ value: 'Temple (मंदिर, मस्जिद)', label: 'Temple (मंदिर, मस्जिद)' },
	{ value: 'Gavthan, Premises', label: 'Gavthan, Premises' },
	{
		value: 'Cremation, burial (स्मशानभूमी, कब्रिस्तान)',
		label: 'Cremation, burial (स्मशानभूमी, कब्रिस्तान)',
	},
	{ value: 'Forest', label: 'Forest' },
	{ value: 'Farm', label: 'Farm' },
	{ value: 'Premises (परिसर)', label: 'Premises (परिसर)' },
	{ value: 'Barren (पडीक)', label: 'Barren (पडीक)' },
	{ value: 'Gairan', label: 'Gairan' },
];

export const LandStrataOptions = [
	{ value: 'Rocky ', label: 'Rocky ' },
	{ value: 'Murum (मुरूम)', label: 'Murum (मुरूम)' },
	{ value: 'Soil (माती)', label: 'Soil (माती)' },
	{ value: 'Roadside (रस्ता काठ)', label: 'Roadside (रस्ता काठ)' },
	{ value: 'Other (इतर)', label: 'Other (इतर)' },
];

export const SampatiPatraOptions = [
...
export const DistrictOptions = [
	{ value: 'Pune (पुणे)', label: 'Pune (पुणे)' },
...
export const BudhanaOptions = [
	{ value: 'Budhana', label: 'Budhana' },
	{ value: 'Nandura (नांदुरा)', label: 'Nandura (नांदुरा)' },
	{ value: 'Motala (मोताळा)', label: 'Motala (मोताळा)' },
	{ value: 'Khamgaon (खामगाव)', label: 'Khamgaon (खामगाव)' },
	{ value: 'Malkapur (मलकापूर)', label: 'Malkapur (मलकापूर)' },
];

export const JalgaonOptions = [
	{ value: 'Jamner (जामनेर)', label: 'Jamner (जामनेर)' },
];

export const PuneOptions = [
	{ value: 'Ambegaon (आंबेगाव)', label: 'Ambegaon (आंबेगाव)' },
	{ value: 'Indapur (इंदापूर)', label: 'Indapur (इंदापूर)' },
	{ value: 'Khed (खेड)', label: 'Khed (खेड)' },
];

export const SambhajinagarOptions = [{ value: 'Soegaon', label: 'Soegaon' }];

export const BudhanaDTOptions = [
	...
	{
		value: 'Borkhed (Dhad) (बोरखेड (धाड))',
		label: 'Borkhed (Dhad) (बोरखेड (धाड))',
	},
	{ value: 'Buldhana (बुलढाणा)', label: 'Buldhana (बुलढाणा)' },
	{
		value: 'Chandol Bhag 1 (चांडोळ भाग 1)',
		label: 'Chandol Bhag 1 (चांडोळ भाग 1)',
	},
	{
		value: 'Chandol Bhag 2 (चांडोळ भाग 2)',
		label: 'Chandol Bhag 2 (चांडोळ भाग 2)',
	},
	...
	{
		value: 'Dongar Khandala (डोंगर खंडाळा)',
		label: 'Dongar Khandala (डोंगर खंडाळा)',
	},
	...
	{
		value: 'Gondhankhed Chautha (गोंधनखेड चौथा)',
		label: 'Gondhankhed Chautha (गोंधनखेड चौथा)',
	},
	...
	{
		value: 'Palaskhed Nago (पळसखेड नागो)',
		label: 'Palaskhed Nago (पळसखेड नागो)',
	},
	{
		value: 'Palaskhed Naik (पळसखेड नाईक)',
		label: 'Palaskhed Naik (पळसखेड नाईक)',
	},
	{ value: 'Paldhag (पलढग)', label: 'Paldhag (पलढग)' },
	{
		value: 'Pangari Bhag 2 (पांगरी भाग 2)',
		label: 'Pangari Bhag 2 (पांगरी भाग 2)',
	},
	{ value: 'Pangarkhed (पांगरखेड)', label: 'Pangarkhed (पांगरखेड)' },
	{
		value: 'Pangri Bhag 1 (पांगरी भाग 1)',
		label: 'Pangri Bhag 1 (पांगरी भाग 1)',
	},
	{
		value: 'Pimpalgaon Sarai (पिंपळगाव सराई)',
		label: 'Pimpalgaon Sarai (पिंपळगाव सराई)',
	},
	{ value: 'Pimparkhed (पिंपरखेड)', label: 'Pimparkhed (पिंपरखेड)' },
	{ value: 'Pokhari (पोखरी)', label: 'Pokhari (पोखरी)' },
	{
		value: 'Raypur Bhag 1 (रायपूर भाग 1)',
		label: 'Raypur Bhag 1 (रायपूर भाग 1)',
	},
	{
		value: 'Raypur Bhag 2 (रायपूर भाग 2)',
		label: 'Raypur Bhag 2 (रायपूर भाग 2)',
	},
	{
		value: 'Ruikhed Mayamba (रुईखेड मायंबा)',
		label: 'Ruikhed Mayamba (रुईखेड मायंबा)',
	},
	{
		value: 'Ruikhed Tekale (रुईखेड टेकाळे)',
		label: 'Ruikhed Tekale (रुईखेड टेकाळे)',
	},
	{ value: 'Sagwan (सागवन)', label: 'Sagwan (सागवन)' },
	{
		value: 'Sakhali Bk. Bhag 1 (साखळी बु.भाग 1)',
		label: 'Sakhali Bk. Bhag 1 (साखळी बु.भाग 1)',
	},
	{
		value: 'Sakhali Bu.Bhag 2 (साखळी बु.भाग 2)',
		label: 'Sakhali Bu.Bhag 2 (साखळी बु.भाग 2)',
	},
	{ value: 'Sakhali Kh. (साखळी खु.)', label: 'Sakhali Kh. (साखळी खु.)' },
	{
		value: 'Satgaon (Mahsala) (सातगांव (म्हसला))',
		label: 'Satgaon (Mahsala) (सातगांव (म्हसला))',
	},
...
export const BudhanaKhamgaonOptions = [
	...
	{
		value: 'Antraj Bhag 1 (अंत्रज भाग1)',
		label: 'Antraj Bhag 1 (अंत्रज भाग1)',
	},
	{
		value: 'Antraj Bhag 2 (अंत्रज भाग 2)',
		label: 'Antraj Bhag 2 (अंत्रज भाग 2)',
	},
	...
	{
		value: 'Chinchkhed Band (चिंचखेड बंद)',
		label: 'Chinchkhed Band (चिंचखेड बंद)',
	},
	{
		value: 'Chinchpur Bhag 1 (चिंचपूर भाग 1)',
		label: 'Chinchpur Bhag 1 (चिंचपूर भाग 1)',
	},
	{
		value: 'Chinchpur Bhag 2 (चिंचपूर भाग 2)',
		label: 'Chinchpur Bhag 2 (चिंचपूर भाग 2)',
	},
	...
	{ value: 'Dudha (दुधा)', label: 'Dudha (दुधा)' },
	{
		value: 'Dyangangapur (ज्ञानगंगापूर)',
		label: 'Dyangangapur (ज्ञानगंगापूर)',
	},
	{ value: 'Fattepur (फत्तेपुर)', label: 'Fattepur (फत्तेपुर)' },
	{
		value: 'Ganeshpur (Maharkhed) (गणेशपूर (महारखेड))',
		label: 'Ganeshpur (Maharkhed) (गणेशपूर (महारखेड))',
	},
	...
	{
		value: 'Gerumatargaon (गेरुमाटरगांव)',
		label: 'Gerumatargaon (गेरुमाटरगांव)',
	},
	{ value: 'Ghanegaon (घाणेगांव)', label: 'Ghanegaon (घाणेगांव)' },
	{
		value: 'Gharod Bhag 1 (घारोड भाग 1)',
		label: 'Gharod Bhag 1 (घारोड भाग 1)',
	},
	{
		value: 'Gharod Bhag 2 (घारोड भाग 2)',
		label: 'Gharod Bhag 2 (घारोड भाग 2)',
	},
	{ value: 'Ghatpuri (घाटपुरी)', label: 'Ghatpuri (घाटपुरी)' },
	{ value: 'Gondhanapur (गोंधणापूर)', label: 'Gondhanapur (गोंधणापूर)' },
	{
		value: 'Hingana Umara (हिंगणा उमरा)',
		label: 'Hingana Umara (हिंगणा उमरा)',
	},
	{
		value: 'Hingna Karegaon (हिंगणा कारेगांव)',
		label: 'Hingna Karegaon (हिंगणा कारेगांव)',
	},
	...
	{
		value: 'Karegaon Bk. (कारेगांव बु.)',
		label: 'Karegaon Bk. (कारेगांव बु.)',
	},
	{
		value: 'Karegaon Kh. (कारेगांव खु.)',
		label: 'Karegaon Kh. (कारेगांव खु.)',
	},
	{ value: 'Kasarkhed (कासारखेड)', label: 'Kasarkhed (कासारखेड)' },
	{ value: 'Kawadgaon (कवडगांव)', label: 'Kawadgaon (कवडगांव)' },
	{
		value: 'Khamgaon Gramin (खामगाव ग्रामीण)',
		label: 'Khamgaon Gramin (खामगाव ग्रामीण)',
	},
	...
	{
		value: 'Kinhi Mahadeo (किन्ही महादेव)',
		label: 'Kinhi Mahadeo (किन्ही महादेव)',
	},
	...
	{
		value: 'Lakhanwada Bk. (लाखनवाडा बु.)',
		label: 'Lakhanwada Bk. (लाखनवाडा बु.)',
	},
	{
		value: 'Lakhanwada Kh. (लाखनवाडा खु.)',
		label: 'Lakhanwada Kh. (लाखनवाडा खु.)',
	},
	{
		value: 'Lanjud Bhag 1 (लांजुड भाग 1)',
		label: 'Lanjud Bhag 1 (लांजुड भाग 1)',
	},
	{
		value: 'Lanjud Bhag 2 (लांजुड भाग 2)',
		label: 'Lanjud Bhag 2 (लांजुड भाग 2)',
	},
	{
		value: 'Lasura Jahangir (लासुरा जहॉगीर)',
		label: 'Lasura Jahangir (लासुरा जहॉगीर)',
	},
	...
	{
		value: 'Parkhed Bhag 1 (पारखेड भाग 1)',
		label: 'Parkhed Bhag 1 (पारखेड भाग 1)',
	},
	{
		value: 'Parkhed Bhag 2 (पारखेड भाग 2)',
		label: 'Parkhed Bhag 2 (पारखेड भाग 2)',
	},
	...
	{
		value: 'Pimpalgaon Raja Bhag 1 (पिंपळगांव राजा भाग 1)',
		label: 'Pimpalgaon Raja Bhag 1 (पिंपळगांव राजा भाग 1)',
	},
	{
		value: 'Pimpalgaon Raja Bhag 2 (पिंपळगांव राजा भाग 2)',
		label: 'Pimpalgaon Raja Bhag 2 (पिंपळगांव राजा भाग 2)',
	},
	{ value: 'Pimprala (पिंपरला)', label: 'Pimprala (पिंपरला)' },
	{
		value: 'Pimpri Deshmukh (पिंपरी देशमुख)',
		label: 'Pimpri Deshmukh (पिंपरी देशमुख)',
	},
	{
		value: 'Pimpri Dhangar (पिंपरी धनगर)',
		label: 'Pimpri Dhangar (पिंपरी धनगर)',
	},
	{ value: 'Pimpri Gawli (पिंपरी गवळी)', label: 'Pimpri Gawli (पिंपरी गवळी)' },
	{
		value: 'Pimpri Korde (पिंपरी कोरडे)',
		label: 'Pimpri Korde (पिंपरी कोरडे)',
	},
	{
		value: 'Pimpri Mohadar (पिंपरी मोहदार)',
		label: 'Pimpri Mohadar (पिंपरी मोहदार)',
	},
	...
	{
		value: 'Sawargaon Bk. (सावरगांव बु.)',
		label: 'Sawargaon Bk. (सावरगांव बु.)',
	},
	{
		value: 'Sawargaon Kh. (सावरगांव खु.)',
		label: 'Sawargaon Kh. (सावरगांव खु.)',
	},
	...
	{
		value: 'Shendri (Sambhapur) (शेंद्री (संभापूर))',
		label: 'Shendri (Sambhapur) (शेंद्री (संभापूर))',
	},
	{ value: 'Shirala (शिराळा)', label: 'Shirala (शिराळा)' },
	{
		value: 'Shirla Nemane (शिर्ला नेमाने)',
		label: 'Shirla Nemane (शिर्ला नेमाने)',
	},
	{
		value: 'Shridhar Nagar (श्रीधर नगर)',
		label: 'Shridhar Nagar (श्रीधर नगर)',
	},
	{
		value: 'Sirasgaon Deshmukh (सिरसगांव देशमुख)',
		label: 'Sirasgaon Deshmukh (सिरसगांव देशमुख)',
	},
	...
	{
		value: 'Vihigaon Bhag 1 (विहिगाव भाग 1)',
		label: 'Vihigaon Bhag 1 (विहिगाव भाग 1)',
	},
	{
		value: 'Vihigaon Bhag 2 (विहिगांव भाग 2)',
		label: 'Vihigaon Bhag 2 (विहिगांव भाग 2)',
	},
...
export const BudhanaMalkapurOptions = [
	...
	{
		value: 'Chinchkhed Bk. (चिंचखेड बु.)',
		label: 'Chinchkhed Bk. (चिंचखेड बु.)',
	},
	{ value: 'Chinchol (चिंचोल)', label: 'Chinchol (चिंचोल)' },
	{ value: 'Dasarkhed (दसरखेड)', label: 'Dasarkhed (दसरखेड)' },
	{
		value: 'Datala Bhag 1 (दाताळा भाग 1)',
		label: 'Datala Bhag 1 (दाताळा भाग 1)',
	},
	{
		value: 'Datala Bhag 2 (दाताळा भाग 2)',
		label: 'Datala Bhag 2 (दाताळा भाग 2)',
	},
	{ value: 'Deodhaba (देवधाबा)', label: 'Deodhaba (देवधाबा)' },
	{ value: 'Dharangaon (धरणगाव)', label: 'Dharangaon (धरणगाव)' },
	{
		value: 'Dudhalgaon Bk. (दुधलगाव बु.)',
		label: 'Dudhalgaon Bk. (दुधलगाव बु.)',
	},
	{
		value: 'Dudhalgaon Kh. (दुधलगांव खु.)',
		label: 'Dudhalgaon Kh. (दुधलगांव खु.)',
	},
	...
	{
		value: 'Ghirni Bhag 1 (घिर्णी भाग 1)',
		label: 'Ghirni Bhag 1 (घिर्णी भाग 1)',
	},
	{
		value: 'Ghirni Bhag 2 (घिर्णी भाग 2)',
		label: 'Ghirni Bhag 2 (घिर्णी भाग 2)',
	},
	...
	{
		value: 'Hingana Nagapur (हिंगणा नागापूर)',
		label: 'Hingana Nagapur (हिंगणा नागापूर)',
	},
	{
		value: 'Hingane Dharangaon (हिंगने धरणगाव)',
		label: 'Hingane Dharangaon (हिंगने धरणगाव)',
	},
	...
	{
		value: 'Malkapur Bhag 1 (मलकापूर भाग 1)',
		label: 'Malkapur Bhag 1 (मलकापूर भाग 1)',
	},
	{
		value: 'Malkapur Bhag 2 (मलकापूर भाग 2)',
		label: 'Malkapur Bhag 2 (मलकापूर भाग 2)',
	},
	{
		value: 'Malkapur Bhag 3 (मलकापूर भाग 3)',
		label: 'Malkapur Bhag 3 (मलकापूर भाग 3)',
	},
	...
	{
		value: 'Narwel Bhag 1 (नरवेल भाग 1)',
		label: 'Narwel Bhag 1 (नरवेल भाग 1)',
	},
	{
		value: 'Narwel Bhag 2 (नरवेल भाग 2)',
		label: 'Narwel Bhag 2 (नरवेल भाग 2)',
	},
	{ value: 'Nimbari (निंबारी)', label: 'Nimbari (निंबारी)' },
	{ value: 'Nimboli (निंबोळी)', label: 'Nimboli (निंबोळी)' },
	{
		value: 'Nimkhed Pr.Vadner (निमखेड प्र.वाडनेर)',
		label: 'Nimkhed Pr.Vadner (निमखेड प्र.वाडनेर)',
	},
	{ value: 'Panhera (पान्हेरा)', label: 'Panhera (पान्हेरा)' },
	{
		value: 'Pimpalkhunta Mahadev (पिंपळखुटा महादेव)',
		label: 'Pimpalkhunta Mahadev (पिंपळखुटा महादेव)',
	},
	{
		value: 'Pimpalkhuta Pr.Vadner (पिंपळखुटा प्र. वडनेर)',
		label: 'Pimpalkhuta Pr.Vadner (पिंपळखुटा प्र. वडनेर)',
	},
...
export const BudhanaMotalaOptions = [
	...
	{
		value: 'Avhayunuspur (आव्हायुनूसपूर)',
		label: 'Avhayunuspur (आव्हायुनूसपूर)',
	},
	...
	{
		value: 'Chinchkhed Kh. (चिंचखेड खु.)',
		label: 'Chinchkhed Kh. (चिंचखेड खु.)',
	},
	{
		value: 'Chinchkhed Nath (चिंचखेड नाथ)',
		label: 'Chinchkhed Nath (चिंचखेड नाथ)',
	},
	...
	{
		value: 'Dhamangaon Badhe Bhag 1 (धामणगाव बढे भाग 1)',
		label: 'Dhamangaon Badhe Bhag 1 (धामणगाव बढे भाग 1)',
	},
	{
		value: 'Dhamangaon Badhe Bhag 2 (धामणगाव बढे भाग 2)',
		label: 'Dhamangaon Badhe Bhag 2 (धामणगाव बढे भाग 2)',
	},
	{
		value: 'Dhamangaon Deshmukh (धामणगांव देशमुख)',
		label: 'Dhamangaon Deshmukh (धामणगांव देशमुख)',
	},
	...
	{
		value: 'Hanwatkhed Gotmara (हनवतखेड गोतमारा)',
		label: 'Hanwatkhed Gotmara (हनवतखेड गोतमारा)',
	},
	{
		value: 'Hanwatkhed Sarolapir (हनवतखेड सारोळापीर)',
		label: 'Hanwatkhed Sarolapir (हनवतखेड सारोळापीर)',
	},
	...
	{ value: 'Khamkhed (खामखेड)', label: 'Khamkhed (खामखेड)' },
	{
		value: 'Khandwa Bhag 1 (खांडवा भाग 1)',
		label: 'Khandwa Bhag 1 (खांडवा भाग 1)',
	},
	{
		value: 'Khandwa Bhag 2 (खांडवा भाग 2)',
		label: 'Khandwa Bhag 2 (खांडवा भाग 2)',
	},
	...
	{
		value: 'Mahalungi Jahagir (महाळुंगी जहागीर)',
		label: 'Mahalungi Jahagir (महाळुंगी जहागीर)',
	},
	...
	{ value: 'Pangarkhed (पांगरखेड)', label: 'Pangarkhed (पांगरखेड)' },
	{
		value: 'Panhera Khedi (पान्हेरा खेडी)',
		label: 'Panhera Khedi (पान्हेरा खेडी)',
	},
	{ value: 'Parda (परडा)', label: 'Parda (परडा)' },
	{
		value: 'Pimpalgaon Devi Bhag 1 (पिपंळगाव देवी भाग 1)',
		label: 'Pimpalgaon Devi Bhag 1 (पिपंळगाव देवी भाग 1)',
	},
	{
		value: 'Pimpalgaon Devi Bhag 2 (पिपंळगाव देवी भाग 2)',
		label: 'Pimpalgaon Devi Bhag 2 (पिपंळगाव देवी भाग 2)',
	},
	{
		value: 'Pimpalgaon Nath (पिंपळगांव नाथ)',
		label: 'Pimpalgaon Nath (पिंपळगांव नाथ)',
	},
	{ value: 'Pimpalpati (पिंपळपाटी)', label: 'Pimpalpati (पिंपळपाटी)' },
	{
		value: 'Pimpri Gawali (पिंप्रीगवळी)',
		label: 'Pimpri Gawali (पिंप्रीगवळी)',
	},
	{ value: 'Pokhari (पोखरी)', label: 'Pokhari (पोखरी)' },
	...
	{
		value: 'Ridhora Jahagir (रिधोरा जहागीर)',
		label: 'Ridhora Jahagir (रिधोरा जहागीर)',
	},
	{
		value: 'Ridhora Khandopant (रिधोरा खंडोपंत)',
		label: 'Ridhora Khandopant (रिधोरा खंडोपंत)',
	},
	{ value: 'Rohinkhed (रोहिणखेड)', label: 'Rohinkhed (रोहिणखेड)' },
	{ value: 'Sahastramuli (सहस्त्रमुळी)', label: 'Sahastramuli (सहस्त्रमुळी)' },
	{
		value: 'Sanglad Pr.Rajur (सांगळद प्र. राजुर)',
		label: 'Sanglad Pr.Rajur (सांगळद प्र. राजुर)',
	},
	{
		value: 'Sarola Maroti (सारोळा मारोती)',
		label: 'Sarola Maroti (सारोळा मारोती)',
	},
	{ value: 'Sarola Pir (सारोळा पिर)', label: 'Sarola Pir (सारोळा पिर)' },
	{
		value: 'Sawargaon Jahagir (सावरगांव जहागीर)',
		label: 'Sawargaon Jahagir (सावरगांव जहागीर)',
	},
	{ value: 'Shahapur (शहापूर)', label: 'Shahapur (शहापूर)' },
	{ value: 'Shelapur Bk. (शेलापूर बु.)', label: 'Shelapur Bk. (शेलापूर बु.)' },
	{ value: 'Shelapur Kh (शेलापूर खु.)', label: 'Shelapur Kh (शेलापूर खु.)' },
	{
		value: 'Shelgaon Bajar (शेलगांव बाजार)',
		label: 'Shelgaon Bajar (शेलगांव बाजार)',
	},
	{ value: 'Shirwa (शिरवा)', label: 'Shirwa (शिरवा)' },
	{
		value: 'Sindkhed Lapali (सिंदखेड लपाली)',
		label: 'Sindkhed Lapali (सिंदखेड लपाली)',
	},
	{ value: 'Sirmil (सिरमिल)', label: 'Sirmil (सिरमिल)' },
	{
		value: 'Sonbarad Pr.Malkapur (सोनबरड प्र.मलकापुर)',
		label: 'Sonbarad Pr.Malkapur (सोनबरड प्र.मलकापुर)',
	},
	{
		value: 'Sonbarad Pr.Rohinkhed (सोनबरड प्र.रोहिणखेड)',
		label: 'Sonbarad Pr.Rohinkhed (सोनबरड प्र.रोहिणखेड)',
	},
	{ value: 'Sultanpur (सुलतानपूर)', label: 'Sultanpur (सुलतानपूर)' },
	{
		value: 'Takli Pr.Malkapur (टाकळी प्र.मलकापुर)',
		label: 'Takli Pr.Malkapur (टाकळी प्र.मलकापुर)',
	},
	{
		value: 'Takli Pr.Rajur (टाकळी प्र.राजूर)',
		label: 'Takli Pr.Rajur (टाकळी प्र.राजूर)',
	},
	...
	{
		value: 'Wadgaon Jamalpur (वडगांव जमालपूर)',
		label: 'Wadgaon Jamalpur (वडगांव जमालपूर)',
	},
	{
		value: 'Wadgaon Mahalungi (वडगांव महाळूगी)',
		label: 'Wadgaon Mahalungi (वडगांव महाळूगी)',
	},
	{
		value: 'Wadgaon Pr.Rohinkhed (वडगांव प्र.रोहिणखेड)',
		label: 'Wadgaon Pr.Rohinkhed (वडगांव प्र.रोहिणखेड)',
	},
...
export const BudhanaNanduraOptions = [
	...
	{
		value: 'Belad Pr.Jalgaon (बेलाड प्र. जळगांव)',
		label: 'Belad Pr.Jalgaon (बेलाड प्र. जळगांव)',
	},
	{ value: 'Belura (बेलुरा)', label: 'Belura (बेलुरा)' },
	...
	{
		value: 'Burti Pr.Chandur (बुर्टी प्र. चांदूर)',
		label: 'Burti Pr.Chandur (बुर्टी प्र. चांदूर)',
	},
	{
		value: 'Burti Pr.Wadner (बुर्टी प्र. वडनेर)',
		label: 'Burti Pr.Wadner (बुर्टी प्र. वडनेर)',
	},
	{
		value: 'Chandur Biswa (चांदूर बिस्वा)',
		label: 'Chandur Biswa (चांदूर बिस्वा)',
	},
	{
		value: 'Chinchkhed Pr.Malkapur (चिंचखेड प्र.मलकापुर)',
		label: 'Chinchkhed Pr.Malkapur (चिंचखेड प्र.मलकापुर)',
	},
	...
	{
		value: 'Dhanora Pr.Chandur (धानोरा प्र.चांदुर)',
		label: 'Dhanora Pr.Chandur (धानोरा प्र.चांदुर)',
	},
	...
	{
		value: 'Hingane Gavhad (हिंगणे गव्हाड)',
		label: 'Hingane Gavhad (हिंगणे गव्हाड)',
	},
	{ value: 'Hingna Bhota (हिंगणा भोटा)', label: 'Hingna Bhota (हिंगणा भोटा)' },
	{
		value: 'Hingne Dadgaon (हिंगणे दादगाव)',
		label: 'Hingne Dadgaon (हिंगणे दादगाव)',
	},
	{
		value: 'Hingne Isapur (हिंगणे इसापूर)',
		label: 'Hingne Isapur (हिंगणे इसापूर)',
	},
	...
	{
		value: 'Lonwadi Pr.Nandura (लोणवडी प्र.नांदुरा)',
		label: 'Lonwadi Pr.Nandura (लोणवडी प्र.नांदुरा)',
	},
	{
		value: 'Mahalungi Pr.Wadner (महाळुंगी प्र. वडनेर)',
		label: 'Mahalungi Pr.Wadner (महाळुंगी प्र. वडनेर)',
	},
	{ value: 'Mahamdpur (महम्मदपूर)', label: 'Mahamdpur (महम्मदपूर)' },
	{
		value: 'Malegaon Pr.P.Raja (माळेगांव प्र. पि. राजा)',
		label: 'Malegaon Pr.P.Raja (माळेगांव प्र. पि. राजा)',
	},
	...
	{ value: 'Patonda (पातोंडा)', label: 'Patonda (पातोंडा)' },
	{
		value: 'Pimpalkhuta Dhande (पिंपळखुटा धांडे)',
		label: 'Pimpalkhuta Dhande (पिंपळखुटा धांडे)',
	},
	{
		value: 'Pimpalkhuta Kh. (पिंपळखुटा खु.)',
		label: 'Pimpalkhuta Kh. (पिंपळखुटा खु.)',
	},
	{
		value: 'Pimpri Adhav (पिंप्री अढाव)',
		label: 'Pimpri Adhav (पिंप्री अढाव)',
	},
	...
	{
		value: 'Rasulpur Pr.Raja (रसुलपूर प्र. राजा)',
		label: 'Rasulpur Pr.Raja (रसुलपूर प्र. राजा)',
	},
	{ value: 'Roti (रोटी)', label: 'Roti (रोटी)' },
	{ value: 'Sangawa (सांगवा)', label: 'Sangawa (सांगवा)' },
	{ value: 'Sanpudi (सानपुडी)', label: 'Sanpudi (सानपुडी)' },
	{
		value: 'Sawargaon Chahu (सावरगांव चाहू)',
		label: 'Sawargaon Chahu (सावरगांव चाहू)',
	},
	{
		value: 'Sawargaon Nehu (सावरगांव नेहू)',
		label: 'Sawargaon Nehu (सावरगांव नेहू)',
	},
	{
		value: 'Shelgaon Mukund (शेलगांव मुकुंद)',
		label: 'Shelgaon Mukund (शेलगांव मुकुंद)',
	},
	...
	{
		value: 'Takli (Watpal) (टाकळी (वटपाळ))',
		label: 'Takli (Watpal) (टाकळी (वटपाळ))',
	},
	{
		value: 'Tandulwadi Pr.Rajur (तांदुळवाडी प्र.राजुर)',
		label: 'Tandulwadi Pr.Rajur (तांदुळवाडी प्र.राजुर)',
	},
	...
	{
		value: 'Wadgaon Dighi (वडगांव डिघी)',
		label: 'Wadgaon Dighi (वडगांव डिघी)',
	},
	{
		value: 'Wadgaon Pr.Raja (वडगांव प्र. राजा)',
		label: 'Wadgaon Pr.Raja (वडगांव प्र. राजा)',
	},
	{
		value: 'Wadi Pr.Malkapur (वाडी प्र.मलकापूर)',
		label: 'Wadi Pr.Malkapur (वाडी प्र.मलकापूर)',
	},
	{
		value: 'Wadi Pr.Wadner (वाडी प्र. वडनेर)',
		label: 'Wadi Pr.Wadner (वाडी प्र. वडनेर)',
	},
	{
		value: 'Wadner Bhag 1 (वडनेर भाग 1)',
		label: 'Wadner Bhag 1 (वडनेर भाग 1)',
	},
	{
		value: 'Wadner Bhag 2 (वडनेर भाग 2)',
		label: 'Wadner Bhag 2 (वडनेर भाग 2)',
	},
...
export const JalgaonJamnerOptions = [
	{ value: 'Ambadi (अंबाडी)', label: 'Ambadi (अंबाडी)' },
	{ value: 'Ambilhol (आंबिलहोल)', label: 'Ambilhol (आंबिलहोल)' },
	{
		value: 'Ambilhol Devi (आंबिलहोल देवी)',
		label: 'Ambilhol Devi (आंबिलहोल देवी)',
	},
	...
	{
		value: 'Chinchakhede Bk (चिंचखेडे बु.)',
		label: 'Chinchakhede Bk (चिंचखेडे बु.)',
	},
	{
		value: 'Chinchkhede Digar (चिंचखेडे दिगर)',
		label: 'Chinchkhede Digar (चिंचखेडे दिगर)',
	},
	{
		value: 'Chinchkhede Tawa (चिंचखेडे तवा)',
		label: 'Chinchkhede Tawa (चिंचखेडे तवा)',
	},
	{
		value: 'Chincholi Pimpri (चिंचोली पिंप्री)',
		label: 'Chincholi Pimpri (चिंचोली पिंप्री)',
	},
	...
	{
		value: 'Gadegaon Pn Nashirabad (गाडेगाव प्र.न नशिराबाद)',
		label: 'Gadegaon Pn Nashirabad (गाडेगाव प्र.न नशिराबाद)',
	},
	...
	{
		value: 'Hingane N.Kasab (हिंगणे न.कसब)',
		label: 'Hingane N.Kasab (हिंगणे न.कसब)',
	},
	{
		value: 'Hingane Pimpri (हिंगणे पिंप्री)',
		label: 'Hingane Pimpri (हिंगणे पिंप्री)',
	},
	{
		value: 'Hivar Khede Bk. (हिवर खेडे बु.)',
		label: 'Hivar Khede Bk. (हिवर खेडे बु.)',
	},
	{ value: 'Hivari Digar (हिवरी दिगर)', label: 'Hivari Digar (हिवरी दिगर)' },
	{
		value: 'Hivarkhede Digar (हिवरखेडे दिगर)',
		label: 'Hivarkhede Digar (हिवरखेडे दिगर)',
	},
	{
		value: 'Hivarkhede Tawa (हिवरखेडे तवा)',
		label: 'Hivarkhede Tawa (हिवरखेडे तवा)',
	},
	{ value: 'Holhaveli (होळ हवेली)', label: 'Holhaveli (होळ हवेली)' },
	{
		value: 'Jalandri Bk. (जळांद्री बु.)',
		label: 'Jalandri Bk. (जळांद्री बु.)',
	},
	{
		value: 'Jalandri Kh. (जळांद्री खु.)',
		label: 'Jalandri Kh. (जळांद्री खु.)',
	},
	...
	{
		value: 'Kasba Pimpri (कसबा पिंप्री)',
		label: 'Kasba Pimpri (कसबा पिंप्री)',
	},
	{
		value: 'Kekat Nimbora (केकत निंभोरा)',
		label: 'Kekat Nimbora (केकत निंभोरा)',
	},
	...
	{
		value: 'Moykhede Digar (मोयखेडा दिगर)',
		label: 'Moykhede Digar (मोयखेडा दिगर)',
	},
	...
	{
		value: 'Nandre Haveli (नांद्रे हवेली)',
		label: 'Nandre Haveli (नांद्रे हवेली)',
	},
	{
		value: 'Nandre Pr.Lohare (नांद्रे प्र.लोहारे)',
		label: 'Nandre Pr.Lohare (नांद्रे प्र.लोहारे)',
	},
	...
	{
		value: 'Nimkhedi Pimpri (निमखेडी पिंप्री)',
		label: 'Nimkhedi Pimpri (निमखेडी पिंप्री)',
	},
	{ value: 'Ozar Bk. (ओझर बु.)', label: 'Ozar Bk. (ओझर बु.)' },
	{ value: 'Ozar Kh. (ओझर खु.)', label: 'Ozar Kh. (ओझर खु.)' },
	{ value: 'Pahur (पहूर)', label: 'Pahur (पहूर)' },
	{
		value: 'Palas Khede Bk. (पळस खेडे बु.)',
		label: 'Palas Khede Bk. (पळस खेडे बु.)',
	},
	{
		value: 'Palas Khede Kakar (पळस खेडे काकर)',
		label: 'Palas Khede Kakar (पळस खेडे काकर)',
	},
	{
		value: 'Palasakhede.Pr.Na (पळासखेडे प्र.न.)',
		label: 'Palasakhede.Pr.Na (पळासखेडे प्र.न.)',
	},
	...
	{
		value: 'Pimpalgaon Bk. (पिंपळगाव बु.)',
		label: 'Pimpalgaon Bk. (पिंपळगाव बु.)',
	},
	{
		value: 'Pimpalgaon Golait (पिंपळगाव गोलाईत)',
		label: 'Pimpalgaon Golait (पिंपळगाव गोलाईत)',
	},
	{
		value: 'Pimpalgaon Kamani (पिंपळगाव कमानी)',
		label: 'Pimpalgaon Kamani (पिंपळगाव कमानी)',
	},
	{
		value: 'Pimpalgaon Kh. (पिंपळगाव खु.)',
		label: 'Pimpalgaon Kh. (पिंपळगाव खु.)',
	},
	{
		value: 'Pimpalgaon Pimpri (पिंपळगाव पिंप्री)',
		label: 'Pimpalgaon Pimpri (पिंपळगाव पिंप्री)',
	},
	...
	{
		value: 'Sarve Pr.Lohare (सर्वे प्र.लोहारे)',
		label: 'Sarve Pr.Lohare (सर्वे प्र.लोहारे)',
	},
	...
	{
		value: 'Shevage Pimpri (शेवगे पिंप्री)',
		label: 'Shevage Pimpri (शेवगे पिंप्री)',
	},
	...
	{
		value: 'Sunasgaon Bk. (सुनसगाव बु.)',
		label: 'Sunasgaon Bk. (सुनसगाव बु.)',
	},
	{
		value: 'Sunasgaon Kh. (सुनसगाव खु.)',
		label: 'Sunasgaon Kh. (सुनसगाव खु.)',
	},
	{ value: 'Takali Bk. (टाकळी बु.)', label: 'Takali Bk. (टाकळी बु.)' },
	{ value: 'Takali Kh. (टाकळी खु.)', label: 'Takali Kh. (टाकळी खु.)' },
	{
		value: 'Takali Pimpri (टाकळी पिंप्री)',
		label: 'Takali Pimpri (टाकळी पिंप्री)',
	},
	...
	{
		value: 'Tighre Wadgaon (तिघ्रे वडगाव)',
		label: 'Tighre Wadgaon (तिघ्रे वडगाव)',
	},
	...
	{
		value: 'Wadgaon Saddo (वडगाव सद्दो)',
		label: 'Wadgaon Saddo (वडगाव सद्दो)',
	},
	{
		value: 'Wadgaon Tighre (वडगाव तिघ्रे)',
		label: 'Wadgaon Tighre (वडगाव तिघ्रे)',
	},
	{ value: 'Wadi (वाडी)', label: 'Wadi (वाडी)' },
...
export const PuneAmbegaonOptions = [
...
export const PuneIndapurOptions = [
...
export const PuneKhedOptions = [
	...
	{ value: 'Kadadhe (कडधे)', label: 'Kadadhe (कडधे)' },
	...
	{
		value: 'Pimpalgaon Tarf Chakan (पिंपळगाव तफे चाकण)',
		label: 'Pimpalgaon Tarf Chakan (पिंपळगाव तफे चाकण)',
	},
	{
		value: 'Pimpalgaon Tarf Khed (पिंपळगांव तर्फे खेड)',
		label: 'Pimpalgaon Tarf Khed (पिंपळगांव तर्फे खेड)',
	},
...
export const SambhajiNagarOptions = [
