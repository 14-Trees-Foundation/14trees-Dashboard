...
function EditSites({ row, openeditModal, closeEditModal, editSubmit }) {
    ...
    const [districtFlag , setFlag] = useState('') //to check the status of district field
    ...
    return (
        ...
        <Dialog open={openeditModal} fullWidth maxWidth="md">
            ...
            <form onSubmit={handleEditSubmit} style={{padding: '40px'}} >
                <DialogContent>
