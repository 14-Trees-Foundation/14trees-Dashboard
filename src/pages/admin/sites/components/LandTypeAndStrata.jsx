...
export const LandTypeAndStrata = ({ values, setValues, handleOrgChange }) => {
    ...
    return (
      <Box sx={{ position: "relative", minHeight: "400px" }}>
                 ...
                 <TextField
                        ...
                        fullWidth
                        // value={land_type}
                        onChange={(e) => setValues({ ...values, land_type: e.target.value })}
                    >
                    ...
                    <TextField
                        ...
                        fullWidth
                        // value={land_strata}
                        onChange={(e) => setValues({ ...values, land_strata: e.target.value })}
                    >
