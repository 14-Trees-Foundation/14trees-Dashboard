        ...
        <>
            <div>
                ...
                <div className={classes.card}>
                    ...
                    <div className={classes.activity}>
                        ...
                        <div className={classes.imageC}>
                            <Carousel hasMediaButton={false} hasIndexBoard={false} images={memories} />
                        </div>
                    </div>
                    <div style={{ padding: '5%', fontSize: '18px', fontWeight: '400', fontFamily: 'Open Sans', lineHeight: '30px', textAlign: 'center', paddingTop: '32px' }}>
                        <span>Apart from reforestation on acquired barren land 14 Trees also partners with local village governments, forest department, farmers, schools etc to plant trees on their land increasing awareness to combat the effects of environmental degradation and climate change as well as support projects on habitat restoration, ground water recharging, biodiversity experiments and also provide livelihood for local tribal villagers.</span>
                    </div>
                </div>
                <div style={{ paddingTop: '15vh', width: '100%' }}>
                    <div style={{ position: 'relative' }}>
                        <img alt="" src={"https://14treesplants.s3.ap-south-1.amazonaws.com/gat/gat_703.jpg"} className={classes.plotimg} />
                        <div className={classes.plotinfo}>
                        </div>
                ...
                <div style={{ width: '100%', textAlign: 'center', position: 'relative' }}>
                    ...
                    <div style={{ width: '130px', marginLeft: 'auto', marginRight: 'auto', paddingTop: '10vh' }}>
                        <img src={trees} alt="tree" className={classes.treeicon} />
                    </div>
                    <div className={classes.treehdr}>
                        The Trees Planted
                    </div>
...
const useStyles = makeStyles((theme) =>
    createStyles({
        imgLogo: {
            position: 'absolute', top: '10%', left: '7%', width: '80px', height: '110px'
        },
        asset1: {
            top: 0, right: 0, position: 'absolute', height: 'auto', width: '60vw',
            [theme.breakpoints.down('1200')]: {
                width: '80vw'
            },
        },
        asset2: {
            top: '49vh', right: 0, position: 'absolute', height: 'auto', width: '45vw', zIndex: '1',
            [theme.breakpoints.down('1200')]: {
                width: '60vw'
            },
        ...
        hdrTxt: {
            position: 'absolute', left: '7%', top: '35%', color: '#ffffff', fontSize: '47px', lineHeight: '66px',
            maxWidth: '50%', fontFamily: 'Noto Serif JP', fontWeight: '500', zIndex: '20',
            [theme.breakpoints.down('1200')]: {
                maxWidth: '70%',
            },
        ...
        card: {
            width: '75vw', minHeight: '100vh', marginLeft: '12vw', marginRight: '12vw', marginTop: '20vh', backgroundColor: '#ffffff', zIndex: '2',
            boxShadow: '0px 0px 30px rgba(0, 0, 0, 0.14)', borderRadius: '35px',
            [theme.breakpoints.down('600')]: {
                width: '90vw',
                marginLeft: '5vw', marginRight: '5vw', marginTop: '15vh',
            },
        },
        wish: {
            fontSize: '50px', fontFamily: 'Noto Serif JP', lineHeight: '72px', textAlign: 'center', paddingTop: '32px',
            [theme.breakpoints.down('600')]: {
                fontSize: '32px',
                lineHeight: '48px',
            },
        ...
        profile: {
            width: '40%', height: 'auto', objectFit: 'cover', borderRadius: '16px',
            [theme.breakpoints.down('600')]: {
                width: '80%',
                height: 'auto',
            },
        ...
        activity: {
            fontSize: '45px', fontFamily: 'Noto Serif JP', lineHeight: '72px', textAlign: 'center', paddingTop: '32px',
            [theme.breakpoints.down('600')]: {
                fontSize: '30px',
                lineHeight: '48px',
            },
        ...
        plotimg: {
            width: '100%', height: '100vh', objectFit: 'cover', filter: 'grayscale(100%)',
        },
        gatLogo: {
            position: 'absolute', left: '46%', width: '120px', height: '120px', opacity: '1', top: '25%',
            [theme.breakpoints.down('480')]: {
                left: '35%',
                top: '10%',
                height: '45vh',
        ...
        asset4: {
            width: '30vw', height: 'auto', top: '-50vh', left: '0', position: 'absolute', zIndex: '-1',
            [theme.breakpoints.down('480')]: {
                top: '-20vh',
                width: '50vw',
            },
        ...
        gatheader: {
            position: 'absolute', width: '100%', top: '45%', opacity: '1', color: '#ffffff', fontFamily: 'Noto Serif JP',
        ...
        gatdesc: {
            width: '60%', marginLeft: 'auto', marginRight: 'auto', textAlign: 'center', marginTop: '0px',
            [theme.breakpoints.down('480')]: {
                width: '90%',
                fontSize: '18px',
                marginTop: '20px',
        ...
        cardasset: {
            position: 'absolute', top: '0', right: '0', width: '40vw', height: 'auto',
            [theme.breakpoints.down('480')]: {
                width: '60%',
                zIndex: '-2'
            },
        ...
        treeimgcontainer: {
            width: '80%', marginLeft: 'auto', marginRight: 'auto', color: '#664E2D',
            [theme.breakpoints.down('480')]: {
                width: '90%',
            },
        },
        ...
        treehdr: {
            color: '#664E2D', fontSize: '45px', fontFamily: 'Noto Serif JP', marginBottom: '32px',
            [theme.breakpoints.down('480')]: {
                fontSize: '24px',
            },
        },
        ...
        companydesc: {
            ...
            fontSize: '24px', fontFamily: 'Noto Serif JP', marginBottom: '5px',
            [theme.breakpoints.down('480')]: {
                fontSize: '18px',
            },
        },
