...
import bdayItem4 from '../../assets/bdayItem4.png';
import bdayItem5 from '../../assets/bdayItem5.png';
            ...
            <div className={classes.header}>
                ...
                <Grid container spacing={4}>
                    <Grid item xs={12} md={5}>
                        ...
                        A thicket of 10 trees has been planted in the name of<br /> 
                        Mr Sanjeev Rathava on the occassion of his birthday.
                        </p>
                        <div className={classes.detail}>
                            <div style={{marginBottom: '5px'}}>Donated by: Mr Biswarup Dutta</div>
                            <div style={{marginBottom: '20px'}}>Date: 21st August 2021</div>
                        </div>
                    </Grid>
                ...
                <div style={{height: '900px', marginTop:'200px'}}>
                    <div
                        style={{position: 'absolute', top: '-100px' ,height: '400px', background: 'linear-gradient(360deg, rgba(233, 234, 231, 0) 0%, #E5E5E7 58.96%)', zIndex:"-1"}}
                    ></div>
                    ...
                    <div style={{position: 'relative'}}>
                         <img className={classes.item4} src={bdayItem4} alt="item1" />
                    </div>
                </div>
                <div className={classes.trees}>
                    ...
                    <div className={classes.treeimgcontainer}>
                        ...
                        </Grid>
                        {
                            showMore && 
                            (
                                <div style={{padding: '24px',marginBottom:'20px', textAlign: 'center'}}>
                ...
                <div style={{position: 'relative'}}>
                         <img className={classes.item5} src={bdayItem5} alt="item1" />
                    </div>
...
const useStyles = makeStyles((theme) =>
    createStyles({
        ...
        plotimg: {
            top: '-500px', zIndex: '-1', width: '100%', position: 'relative', height: '100%', objectFit: 'cover',
            [theme.breakpoints.down('480')]: {
                height: '80%',
            },
        },
        ...
        gatheader: {
            marginTop: '10px', width: '80%', marginLeft: 'auto', marginRight: 'auto',
            fontSize: '40px', textAlign: 'center', color:'#ffffff', fontWeight: '600',
            [theme.breakpoints.down('480')]: {
                fontSize: '25px',
                width: '100%',
                marginTop: '5px'
