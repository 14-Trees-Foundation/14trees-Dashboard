        ...
        <Card sx={{ display: 'flex', margin: '0 auto', padding: 2, borderRadius: 4, boxShadow: 3 }}>
            ...
            <CardContent sx={{ flex: '1 1 auto' }}>
                <Typography variant="body1" component="p">
                    Every leaf that unfurls is a promise of a greener tomorrow. {getName()}'s dedication and care in planting this tree are invaluable contributions to our mission of a healthier planet. As you visit this page, take a moment to appreciate the life and beauty this tree brings to our world.
                </Typography>
            </CardContent>
        </Card>
    );
