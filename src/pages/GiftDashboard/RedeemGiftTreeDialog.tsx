    ...
    const handleSubmit = async () => {
        try {
            ...
            if (isEditMode && existingTransaction) {
                ...
                if (giftMultiple) {
                    await apiClient.redeemMultipleGiftCardTemplate(treesCount, 'user', userId, data, profileImageUrl, messages);
                    toast.success("Successfully gifted trees!");
                } else {
                    await apiClient.redeemGiftCardTemplate('user', userId, tree.giftCardId, tree.saplingId, tree.treeId, data, profileImageUrl, messages);
