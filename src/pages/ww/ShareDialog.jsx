        ...
        return (
            ...
            <DialogContent>
                <div style={{marginLeft: 'auto', marginRight: 'auto', maxWidth: '720px'}}>
                    ...
                    >
                        <canvas ref={canRef} width={2191} height={2884} style={{display:'none'}}/>
                        ...
                        <Grid container spacing={2} style={{textAlign:'center'}}>
                            <Grid item xs={12} lg={6}>
                                ...
                                <div style={{width:'100%', textAlign:'center'}}>
                                    <span style={{fontSize:'16px',paddingRight:'8px'}}>Wish Birthday</span>
                            ...
                            <Grid item xs={12} lg={6}>
                                ...
                                <div style={{width:'100%', textAlign:'center'}}>
                                    <span style={{fontSize:'16px',paddingRight:'8px'}}>Happy New Year</span>
