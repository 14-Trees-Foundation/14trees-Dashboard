...
import { Button, Dialog, DialogContent, DialogTitle, Slide, TextField, Typography } from '@mui/material';
...
export const CreateAlbumDialog = (props) => {
    ...
    return (
        ...
        >
            ...
            <ToastContainer/>
            <DialogContent>
                <div style={{marginLeft: 'auto', marginRight: 'auto', maxWidth: '380px'}}>
                    <TextField
                        variant='outlined'
                        label='Album name'
                    ...
                    <div className={classes.imgdiv}>
                        <section>
                            <div {...getRootProps()}>
                            <input {...getInputProps()} />
                                <p style={{cursor: 'pointer'}}>Upload album images. Click or Drag!</p>
                            </div>
                        </section>
                    </div>
