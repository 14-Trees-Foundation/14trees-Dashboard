...
export type SponsorshipType =
	...
	| 'Unsponsored Visit'
	| 'Donation Received';
export type PlotAutoBookMode = 'percentage' | 'count';

export type PlotAutoBookRule = {
	plot_id: number;
	mode: PlotAutoBookMode;
	value: number;
...
export const GiftRequestType_NORAML_ASSIGNMENT: GiftRequestType =
	'Normal Assignment';
