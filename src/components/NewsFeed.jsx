        ...
        if (value.type === '2') {
            ...
            return (
                <div>
                    ...
                    <div style={{ marginTop: '3px', fontWeight: '450', fontSize: '12px' }}>
                        {date}
                    </div>
            ...
            return (
                <div>
                    <div style={{ display: 'flex', marginTop: '5%' }}>
                        <img className={classes.actimg} src={value.images[0]} alt={'video'} />
                        <div style={{ marginTop: '8%', fontWeight: '500', fontSize: '12px' }}>
                            {value.title}
                            <div style={{ marginTop: '3px', fontWeight: '350', fontSize: '10px' }}>
                                {date}
                            </div>
                        </div>
                    </div>
