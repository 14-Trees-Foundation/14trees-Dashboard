...
import { getDialogTitleWithReqId } from '../pages/admin/gift/utils/dialogTitle';
...
const AlbumImageInput: React.FC<AlbumImageInputProps> = ({
	onSave,
	onClose,
	open,
	imageUrls,
		...
		<Modal open={open}>
			...
			>
				<Typography variant="h6" gutterBottom>
					{getDialogTitleWithReqId('Occasion/Event memories', requestId)}
				</Typography>
				<Typography mt={1} mb={1}>
					You can add memories to your occasion/event. These will be shown on
					the tree dashboard of each of the tree recipients.
				</Typography>
				<DndProvider backend={HTML5Backend}>
					...
					>
						...
						<Typography variant="body2">
							Drag & drop or click to select images (max 10)
						</Typography>
					</Box>
					<Box
						ref={scrollableRef}
				...
				<Grid container spacing={1} justifyContent="flex-end">
					{onDeleteAlbum && imageUrls && imageUrls.length > 0 && (
						<Grid item>
